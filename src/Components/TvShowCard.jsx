...
function TvShowCard({
  tvShow: { id, name, vote_average, poster_path, first_air_date, original_language, is_favorite },
  className = "",
}) {
  ...
  const toggleLike = async (e) => {
    ...
    try {
      if (next) {
        await addFavorite(MEDIA_TYPE, { id, title: name, poster_path, vote_average, release_date: first_air_date, original_language })
      } else {
